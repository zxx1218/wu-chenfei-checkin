    ...
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container max-w-md mx-auto px-4 relative z-10">
        ...
        <div className="space-y-5">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center group-hover:animate-home-wiggle">
                <span className="text-3xl">⏰</span>
              </div>
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-foreground">定时推送管理</h2>
                <p className="text-sm text-muted-foreground">配置每天自动推送消息（当前支持天气）</p>
              </div>
              <span className="text-muted-foreground/50 group-hover:text-primary group-hover:translate-x-1 transition-all duration-300 text-xl">→</span>
            </div>
          </Link>
